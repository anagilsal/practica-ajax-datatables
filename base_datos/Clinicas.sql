...
ALTER TABLE `clinica_doctor`
  ADD CONSTRAINT `fk_clinica_doctor_clinicas1` FOREIGN KEY (`id_clinica`) REFERENCES `clinicas` (`id_clinica`) ON DELETE CASCADE,
  ADD CONSTRAINT `fk_clinica_doctor_Doctores` FOREIGN KEY (`id_doctor`) REFERENCES `doctores` (`id_doctor`) ON DELETE CASCADE;
